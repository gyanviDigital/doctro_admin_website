...
Route::group(['middleware' => ['XssSanitizer']], function ()
{
    ...
    Route::middleware(['auth'])->group(function ()
    {
        ...
        //emergencyText
        Route::get('emergencyText',[WebsiteController::class,'emergencyText']);
    ...
    // software-charge
    Route::get('/software-charge',[AdminController::class,'softwarecharge']);
    // career-details
    Route::get('/career-details',[AdminController::class,'careerdetails']);
    // software-charge-post
    Route::post('/software-charge-post',[AdminController::class,'softwarechargepost']);
    Route::middleware(['auth'])->group(function ()
    {
        Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home');
        // Settings
        Route::get('/settin',[SettingController::class,'setting']);
    ...
    Route::middleware(['auth'])->group(function ()
    {
        ...
        Route::get('/schedule-emergency',[App\Http\Controllers\Doctor\DoctorController::class,'scheduleEmergency']);
        Route::post('/add_emergency',[App\Http\Controllers\Doctor\DoctorController::class,'addemergency']);
        //emergenyEdit
        
        Route::get('emergenyEdit/{id?}',[App\Http\Controllers\Doctor\DoctorController::class,'emergenyEdit']);
        // /delete-emergency
        Route::get('delete-emergency/{id?}',[App\Http\Controllers\Doctor\DoctorController::class,'deleteemergency']);
        // doctor profile
...
//Home routs
// Route::get('/',[App\Http\Controllers\Home_controller::class,'index']);
// Route::get('/about-us',[App\Http\Controllers\Home_controller::class,'about_us']);
Route::post('search',[App\Http\Controllers\Home_controller::class,'search']);
Route::get('all-doctors',[WebsiteController::class,'doctor']);
Route::get('company-profile',[App\Http\Controllers\Home_controller::class,'company_profile']);
Route::get('mission-vission',[App\Http\Controllers\Home_controller::class,'mission_vission']);
Route::get('founder-message',[App\Http\Controllers\Home_controller::class,'founder_message']);
Route::get('doctors-profile',[App\Http\Controllers\Home_controller::class,'doctors_profile']);
Route::get('doc-profile/{id?}',[App\Http\Controllers\Home_controller::class,'profile']);
Route::get('services',[App\Http\Controllers\Home_controller::class,'services']);
Route::get('contact-us',[App\Http\Controllers\Home_controller::class,'contact']);
Route::get('faqs',[App\Http\Controllers\Home_controller::class,'faqs']);
Route::get('book/{id?}',[App\Http\Controllers\Home_controller::class,'book']);
//hospital
Route::get('hospital-doctors/{id?}',[App\Http\Controllers\Home_controller::class,'hospitalData']);
Route::post('contact-us-post',[App\Http\Controllers\Home_controller::class,'contactUs']);
//all-hospital
Route::get('all-hospital',[App\Http\Controllers\Home_controller::class,'allHospital']);
//find
// termscondition
Route::get('termscondition',[App\Http\Controllers\Home_controller::class,'termscondition']);
// refund-policy
Route::get('refund-policy',[App\Http\Controllers\Home_controller::class,'refundpolicy']);
//payment
...
// career
Route::get('career',[App\Http\Controllers\Home_controller::class,'career']);
// career-post
Route::post('career-post',[App\Http\Controllers\Home_controller::class,'careerpost']);
