...
class DoctorController extends Controller
{
    ...
    public function scheduleEmergency(){
        ...
        $slotData=DB::table('emergency_slot')
        ->where('doctor_id', $doctor->id)
        ->orderBy('id','desc')
        ->get();
    
        return view('doctor.doctor.doctor_emergency',compact('slotData'));
    }
  ...
  public function emergenyEdit($id){
    $slotData=DB::table('emergency_slot')
    ->where('id',$id)
    ->get();
    echo 'edit';
    ...
    public function addemergency( Request $request){
        ...
        $slotData=DB::table('emergency_slot')->insert($data);
        return redirect()->back();
        // return view('doctor.doctor.add_emergency',compact('slotData'));
