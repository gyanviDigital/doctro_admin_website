            ...
            <div class="card-body">
                ...
                <div class="row mt-4">
                    <div class="col-lg-6 form-group">
                        ...
                        <option value="2" {{ $doctor->timeslot == 2 ? 'selected' : '' }}>2</option>
                        <option value="5" {{ $doctor->timeslot == 5 ? 'selected' : '' }}>5</option>
                        <option value="10" {{ $doctor->timeslot == 10 ? 'selected' : '' }}>10</option>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-6 form-group base_on_com {{ $doctor->based_on != 'commission' ? 'hide' : '' }}" style="display: none;">
