    ...
    @include('layout.breadcrumb',[
        ...
        <div class="card">
            <div class="card-header" style="display: flex; justify-content:space-between;">
             ...
             <a href="{{url('schedule-emergency')}}"> <button style="padding: 8px 20px; border-radius:10px; background-color:green; color:white; font-weight:700; ">Emergency Add</button></a>
            </div>
            <div class="card-body">
