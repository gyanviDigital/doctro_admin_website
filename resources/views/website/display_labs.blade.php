...
<div class="mainDiv border border-white-light">
    ...
    <div class="hoverDoc bg-white shadow-2xl p-5 relative hover:z-50 hover:w-full hover:h-full xxsm:w-full xxsm:h-[500px] xsm:h-[450px] md:h-[300px] xlg:w-[285px] lg:h-[300px] lg:overflow-y-auto xl:w-[255px] 1xl:h-[350px] 1xl:overflow-y-auto 1xl:w-[500px] 2xl:w-[560px]">
            ...
            <div class="xxsm:w-full xsm:w-full 1xl:w-[60%] xlg:w-full md:w-[60%] lg:w-full xxsm:pl-0 xmd:pl-10 xxsm:ml-0 xlg:pl-0 lg:ml-0 lg:pl-0 1xl:pl-5 md:pl-5 md:border-l-2 md:border-white-light xxsm:border-l-0 lg:border-l-0 xl:border-l-0 xl:pl-0 1xl:border-l-2 h-[200px]">
                <div>
                    ...
                    <div class="flex xl:flex-col xlg:flex-row lg:flex-row xsm:flex-row xxsm:flex-col items-center 1xl:flex-row">
                        <a href="{{ url('lab_test/' . $lab['id'] . '/' . Str::slug($lab['name'])) }}" class="font-fira-sans text-white bg-primary hover:bg-primary text-sm text-center py-2.5 px-5 bg-blue-500 px-2">{{__('Test Report')}}</a>
                    </div>
                </div>
            </div>
        </div>
