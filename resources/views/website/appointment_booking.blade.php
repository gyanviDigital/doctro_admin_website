    ...
    <div class="xsm:mx-4 xxsm:mx-5 pt-10 mb-10 ">
        ...
        <div class="Appointment-detail border border-white-light">
            ...
            <form id="appointmentForm">
                ...
                @if($emergencyData)
                @if($emergencyData->slot_no>$emergencyData->total_patient)
 <select onchange="emergencytypes()" name="types" id="emergency" style="width: 100%; ">
    <option value="1">Genaral</option>
    <option value="2">Emergency</option>
 </select>
       @else
       <select onchange="types()" name="types" id="emergency" style="width: 100%; ">
    <option value="1">Genaral</option>
    <!-- <option value="1" class="" style="background-color: red; color:white;">Emergency Slot Full</option> -->
 </select>
 <span style="color:red; margin-left:10px;">Emergency slot Full</span>
       @endif
       @else
       <select onchange="types()" name="types" id="emergency" style="width: 100%; ">
    <option value="1">Genaral</option>
                ...
                <div id="step3" class="hidden">
                    <div class="flex xlg:flex-row xxsm:flex-col">
                        <div class="col-span-5 p-5 w-full">
                            ...
                            <div class="grid grid-cols-1 gap-1 md:grid-cols-4 msm:grid-cols-2">
                                <div>
                                    ...
                                    <div class="border border-1 border-white-light font-fira-sans paymentDiv text-center p-5 activePayment" data-attribute="cod">
                                        <img class="m-auto" width="50px" height="20px" src="{{ url('images/website/reception.jpg') }}" alt="">
                                        <p class="mt-3 overflow-hidden">{{ __('COR') }}</p>
                                    </div>
                                    @endif
                                </div>
                                <div>
                            ...
                            <h1 class="" id="alertDisable" style="text-align: center; place-self:center; color:red; margin-top:20px;"> After Pay Platform Charge , Booking Button Enable !</h1>
                            <h1 class="" id="alertEnable" style="text-align: center; display:none; place-self:center; color:green; margin-top:20px;"> Booking Button Enable !</h1>
                            <div class="codDiv text-center" id="">
                            <input  type="button" id="bookingChargeBtn" class="font-fira-sans text-white !bg-primary p-3 text-sm font-normal w-40 h-11 cursor-pointer mt-10" onclick="bookingCharge()" value="{{__('Pay Booking Charge')}}">
                            <!--  payment disabled-->
                                <input disabled id="payBtn" style="background-color: gray;"  type="button" class="font-fira-sans text-white  p-3 text-sm font-normal w-40 h-11 cursor-pointer mt-10" onclick="booking()" value="{{__('Pay Cash on Reception')}}">
                            </div>
                            ...
                            <div class="razorpayDiv text-center mt-5 hidden">
                                ...
                                <!-- id='razorPayBtn' -->
                                <input disabled type="button" id="paybtn" onclick="RazorPayPayment()" value="{{__('Pay with Razorpay')}}" class="font-fira-sans text-white  p-3 text-sm font-normal py-3 cursor-pointer" style="background-color: gray;">
                          
                                <!-- <input  type="button"  id='razorPayBtn' style="background-color: gray;" onclick="RazorPayPayment()" value="{{__('Pay with Razorpay')}}" class="font-fira-sans text-white  p-3 text-sm font-normal py-3 cursor-pointer"> -->
                            </div>
       <div class="" style="box-shadow: 1px .3px 5px .1px gray; padding:30px; border-radius:20px; display:grid; place-items:center; margin-top:20px;">
        <div class="" style="width: 100%; height:auto; ">
      <h3 class="">  Refund Policy</h3>

<strong> Repay:</strong> <br>
1.Platform Fee of ₹35 Within 7 business days from the date of claiming  <br>
2. If Doctor's fee paid via platform, will be refunded within 7 days of claiming <br>
3. If Doctor's fee paid at counter, contact Doctor's reception <br>

<strong> Conditions:</strong> <br>
1. Unable to meet the doctor on the date of booked slot <br>
   2.Claimed within 3 days of booking <br>
        </div>
       </div>
                        </div>
                        <div class="xxsm:w-full lg:w-[33%]">
                            ...
                            <div class="border !border-t-0 border-white-light p-5">
                                ...
                                <div class="font-fira-sans mt-4">
                                    {{ __('Appointment Fees : ') }} <span class="text-base font-medium text-primary">{{ $currency }}<span class="appointmentFees">{{ $doctor->appointment_fees + 400 }}</span></span>
                                </div>
                                <div class="font-fira-sans mt-4">
        ...
        <div class="Appointment-detail flex justify-between mt-3 mb-3">
            ...
            <!-- <button  onclick="bookingCheck()" class="!text-white !bg-primary text-center text-base font-normal font-fira-sans w-32 h-11">Book</button> -->
            <button type="button" class="!text-white !bg-primary text-center text-base font-normal font-fira-sans w-60 h-11" id="next">{{ __('Next')}}</button>
        </div>
    </div>
...
<!-- <div class="codDiv text-center" style="position: relative; background-color:orange; display:grid; place-items:center;">
...
<h1 id="sss" >Pay with Razorpay</h1>
    <form  id="paymentForm2">
        <input type="number" id="amount" placeholder="Enter amount" value="2" required>
...
let bookingChargeBtn = document.getElementById('bookingChargeBtn');
let payBtn = document.getElementById('payBtn');
let razorPayBtn = document.getElementById('paybtn');
let alertDisable = document.getElementById('alertDisable');
let alertEnable = document.getElementById('alertEnable');
    ...
    razorPayBtn.style.backgroundColor='blue';
    bookingChargeBtn.style.display='none';
    alertDisable.style.display='none';
alertEnable.style.display='block';
