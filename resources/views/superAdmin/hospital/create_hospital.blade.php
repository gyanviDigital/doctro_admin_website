...
<section class="section">
    ...
    <div class="section_body">
        <div class="card">
            <form action="{{ url('hospital') }}" method="post" class="myform" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" value="{{ old('image') }}" name="image" class="form-control @error('phone') is-invalid @enderror">
                            @error('image')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>  
