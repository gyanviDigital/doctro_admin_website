                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6 form-group base_on_com hide">
                            ...
                            <input type="number" min="0" step="any" value="{{ old('commission_amount') }}" name="commission_amount" class="form-control base_on_com_text @error('commission') is-invalid @enderror">
