...
function shoeStep() {
  ...
  //emergency missing
  let selectedByUse=document.getElementById('emergency').value;
//   alert(selectedByUse);
...
{
    // amount = $('input[name=amount]').val();
    // var checkTypes= document.getElementById('emergency').value;
   
    // checkTypes==2?amount=$('input[name=amount2]').val():amount=$('input[name=amount]').val();
